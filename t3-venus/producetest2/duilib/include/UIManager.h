...
#define NOTIFY_SELECTCHANGED	_T("selectchanged")
...
#define NOTIFY_ITEMCLICK		_T("itemclick")
#define NOTIFY_TIMER			_T("timer")
#define NOTIFY_SCROLL           _T("scroll")
#define NOTIFY_ITEMACTIVATE		_T("itemactivate")
#define NOTIFY_HEADERCLICK		_T("headerclick")
#define NOTIFY_SIZE				_T("size")
#define NOTIFY_DESTROY			_T("destory")
#define NOTIFY_KEYUP			_T("keyup")
#define NOTIFY_KEYDOWN			_T("keydown")
#define NOTIFY_CHAR				_T("char")
#define NOTIFY_MINMIAXINFO		_T("minmaxinfo")
#define NOTIFY_MOVE				_T("move")
#define NOTIFY_DBLCLICK			_T("dblclick")
