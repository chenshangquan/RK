...
{
public:
	static const CStdString st_str_inset;
	static const CStdString st_str_mousechild;
	static const CStdString st_str_vscrollbar;
	static const CStdString st_str_vscrollbarstyle;
	static const CStdString st_str_hscrollbar;
	static const CStdString st_str_hscrollbarstyle;
	static const CStdString st_str_childpadding;
public:
    CContainerUI();
...
{
public:
	static const CStdString st_str_sepheight;
	static const CStdString st_str_sepimm;
public:
    CVerticalLayoutUI();
...
{
public:
	static const CStdString	st_str_sepwidth;
	static const CStdString	st_str_sepimm;
public:
    CHorizontalLayoutUI();
...
{
public:
	static const CStdString st_str_columns;
public:
    CTileLayoutUI();
...
{
public:
	static const CStdString st_str_selectedid;
public:
    CTabLayoutUI();
